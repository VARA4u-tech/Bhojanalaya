        ...
        return (
            ...
            >
                ...
                <div className="relative overflow-hidden rounded-t-xl">
                    ...
                    >
                        <div className={cn(
                            ...
                            isVegetarian ? "border-green-600 bg-white/90" : "border-red-600 bg-white/90"
                        )}>
                            <div className={cn(
                ...
                <div className="flex flex-col flex-grow p-4 text-left">
                    ...
                    {/* --- ITEM NAME --- */}
                    <h3 className="mt-2 text-base font-semibold leading-tight text-foreground line-clamp-2">{name}</h3>
