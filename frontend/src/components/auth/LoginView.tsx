...
import { Loader2, Mail, Lock, User, ArrowRight, Wand2, Eye, EyeOff } from "lucide-react";
...
export function LoginView() {
    ...
    const { loginWithPassword, signUpWithPassword, loginWithMagicLink, loginWithGoogle } = useUserStore();
    ...
    return (
        <div className="w-full max-w-[420px] mx-auto">
            <div className="bg-white rounded-3xl shadow-soft-xl border border-border/40 p-6 sm:p-8 animate-in fade-in zoom-in-95 duration-500">
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground text-sm">
                        {activeTab === 'login' ? 'Enter your credentials to access your account' : 'Sign up to start your food journey'}
                    </p>
                </div>
                ...
                <Tabs defaultValue="login" value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <TabsContent value="login" className="space-y-4 mt-0 focus-visible:outline-none">
                        <form onSubmit={handleLogin} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 h-12 rounded-xl bg-muted/30 border-border focus:border-primary/50 focus:bg-white transition-all"
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            {!showMagicLink && (
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Button variant="link" className="p-0 h-auto text-xs text-primary font-normal hover:underline" type="button" onClick={() => setShowMagicLink(true)}>
                                            Forgot password?
                                        </Button>
                                    </div>
                                    <div className="relative group">
                                        ...
                                        <Input
                                            ...
                                            className="pl-10 pr-10 h-12 rounded-xl bg-muted/30 border-border focus:border-primary/50 focus:bg-white transition-all"
                            ...
                            <Button type="submit" className="w-full h-12 rounded-xl font-bold shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] transition-all" disabled={isLoading}>
                                {isLoading ? (
                                    <>
                            ...
                            <div className="text-center">
                                ...
                                >
                                    {showMagicLink ? (
                                        <>
                                            <Lock className="mr-1.5 h-3 w-3" /> Back to password login
                                        </>
                                    ) : (
                                        <>
                                            <Wand2 className="mr-1.5 h-3 w-3" /> Use magic link instead
                                        </>
                                    )}
                                </Button>
                            </div>
                    ...
                    <TabsContent value="signup" className="space-y-4 mt-0 focus-visible:outline-none">
                        <form onSubmit={handleSignUp} className="space-y-4">
                            ...
                            <p className="text-xs text-center text-muted-foreground mt-4 px-4 leading-relaxed">
                                By joining, you agree to our <a href="#" className="underline decoration-dotted underline-offset-2 hover:text-primary hover:decoration-solid">Terms of Service</a> and <a href="#" className="underline decoration-dotted underline-offset-2 hover:text-primary hover:decoration-solid">Privacy Policy</a>.
                            </p>
                        </form>
                    </TabsContent>
                </Tabs>
